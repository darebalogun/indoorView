						...
						<div class="inner">
							...
							<div class="flex flex-2">
								<div class="col col2">
									...
									<h6>This is where IndoorView comes in! IndoorView would allow users to view the inside of buildings of Carleton University. Furthermore, it allows users to search for specific rooms in the buildings.  IndoorView would display a panoramic view of the inside of the building at the specified rooms/areas. An application like this is very useful as it is easy to get lost when navigating though the buildings and a visual display of the inside would be very helpful to users. </h6>
								</div>
